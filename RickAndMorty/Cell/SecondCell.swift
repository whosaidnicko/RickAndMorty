...
class SecondCell: UITableViewCell {
    ...
    func setLabel() {
        ...
        nameHero.layer.frame = CGRect(x: 145, y: 12, width: 300, height: 30)
    ...
    func setImage() {
        pictureHero.layer.frame = CGRect(x: 25, y: 4, width: 114, height: 114)
    ...
    func setShadow() {
        shadow.layer.frame = CGRect(x: 32, y: 7, width: 320 , height: 108)
    ...
    func backMainViewSet() {
        backMainView.layer.frame = CGRect(x: 25, y: 4, width: 330, height: 114)
    ...
    func setLabelLocation(){
        labelLocation.layer.frame = CGRect(x: 145, y: 32, width: 250, height: 30)
    ...
    func setStaticLabelEp() {
        ...
        staticLabelEpisode.layer.frame = CGRect(x: 145, y: 23, width: 80, height: 80)
    ...
    func setDinamicLabelEp() {
        dinamicLabelEpisode.layer.frame = CGRect(x: 145, y: 35, width: 170, height: 80)
